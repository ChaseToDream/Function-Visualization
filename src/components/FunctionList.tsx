  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="opacity-0 group-hover:opacity-100 text-surface-400 hover:text-red-500 focus:outline-none ml-2 flex-shrink-0 transition-all duration-150 p-1 hover:bg-red-50 rounded-md"
  ...
  if (isEmpty) {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-xs text-surface-500 mt-0.5">在上方输入表达式添加</p>
      </div>
    );
  }
